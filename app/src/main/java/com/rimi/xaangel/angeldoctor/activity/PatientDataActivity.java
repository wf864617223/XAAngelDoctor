...
import com.rimi.xaangel.angeldoctor.adapter.MyViewPagerAdapter;
import com.rimi.xaangel.angeldoctor.adapter.ReportCommonAdapter;
import com.rimi.xaangel.angeldoctor.bean.PatientData;
import com.rimi.xaangel.angeldoctor.bean.ReportDate;
import com.rimi.xaangel.angeldoctor.fragment.RecordFragment;
import com.rimi.xaangel.angeldoctor.fragment.ReportListFragment;
import com.rimi.xaangel.angeldoctor.http.HttpUrls;
import com.rimi.xaangel.angeldoctor.http.MyCallBack;
import com.rimi.xaangel.angeldoctor.http.PhoneCallBack;
import com.rimi.xaangel.angeldoctor.http.XHttpRequest;
import com.rimi.xaangel.angeldoctor.utils.Base64Utils;
import com.rimi.xaangel.angeldoctor.utils.CommonUtils;
import com.rimi.xaangel.angeldoctor.utils.GsonUtils;
import com.rimi.xaangel.angeldoctor.utils.HttpLoadImg;
...
//                        ageTv.setText(getResources().getString(R.string.age) + result.getString("Age"));
                        ...
                        String ItemResult1 = result.getString("msresult");
