...
import com.rimi.xaangel.angeldoctor.utils.JudgePushToken;
import com.rimi.xaangel.angeldoctor.utils.SPUtils;
import com.rimi.xaangel.angeldoctor.widget.ScrollbleViewPager;
        ...
        public void run() {
            boolean isUpdate = UpdateManager
                    .getUpdateInfo( GuideActivity.this,
                            "http://app.xaangel.com/checkversioncode.json",
                            true);
            if (isUpdate) {
